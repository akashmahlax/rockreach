      ...
      >
        <div className="flex h-full flex-col">
                ...
                <CollapsibleTrigger asChild>
                  <button className="w-full flex items-center justify-between p-2 text-sm font-medium text-slate-700 hover:bg-slate-50 rounded-lg">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-green-400">AI Usage</span>
                    </div>
                    {isUsageStatsOpen ? (
          ...
          <div className="border-t border-slate-200">
            ...
            {/* User Info */}
            {user.name && (
              <div className="border-t flex flex-row border-slate-200 p-3">
                <div className="flex items-center gap-3">
                  ...
                  {isSidebarExpanded && (
                    <div className="flex-1 flex-row min-w-0">
                      ...
                      <div>
                          <Link href="/settings" className="flex items-center gap-1 text-xs text-amber-700 hover:underline mt-0.5"> 
                          <Settings className="h-4 w-4 shrink-0" />
                          </Link>
                      </div>
                    </div>
